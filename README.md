...
- bitumseeder will now be installed in either ```$GOROOT/bin``` or
...
* The `bitumseeder` executable will be installed to `$GOPATH/bin`.  `GOPATH`
  defaults to `$HOME/go` (or `%USERPROFILE%\go` on Windows) if unset.

For more information about Bitum and how to set up your software please go to
our docs page at [docs.bitum.io](https://docs.bitum.io/getting-started/beginner-guide/).

To start bitumseeder listening on udp 127.0.0.1:5354 with an initial connection to working testnet node 192.168.0.1:

```
$ ./bitumseeder -n nameserver.example.com -H network-seed.example.com -s 192.168.0.1 --testnet
```
...
The [integrated github issue tracker](https://github.com/bitum-project/bitumseeder/issues)
is used for this project.

## License

bitumseeder is licensed under the [copyfree](http://copyfree.org) ISC License.
