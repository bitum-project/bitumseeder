...
DOCKER_IMAGE_TAG=bitum-project-golang-builder-$GOVERSION
$DOCKER pull bitum-project/$DOCKER_IMAGE_TAG

$DOCKER run --rm -it -v $(pwd):/src:Z bitum-project/$DOCKER_IMAGE_TAG /bin/bash -c "\
